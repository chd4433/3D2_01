...
public:
	...
	const BoundingOrientedBox GetBB() const { return m_xmOOBB; };
...
public:
	...
	virtual void Render(ID3D12GraphicsCommandList* pd3dCommandList); //파티클 용
...
{
public:
	CCubeMeshTextured(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, XMFLOAT3 extent);
