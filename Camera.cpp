...
CFirstPersonCamera::CFirstPersonCamera(CCamera *pCamera) : CCamera(pCamera)
{
	...
	if (pCamera)
	{
		...
		XMFLOAT3 pos = Vector3::Normalize(m_pPlayer->GetLookVector());
		//m_xmf3Position = Vector3::Subtract(m_xmf3Position, XMFLOAT3(0.0f, -2.25f, -1.0f));
		m_xmf3Position = Vector3::Subtract(m_xmf3Position, XMFLOAT3(0.0f, -2.25f, 0.0f));
		m_xmf3Position = Vector3::Add(m_xmf3Position, pos);
	}
}
...
void CFirstPersonCamera::MovingRotate(float x, float y, float z)
{
	if (m_pPlayer && (x != 0.0f))
	{
		XMFLOAT3 xmf3Right = m_pPlayer->GetRightVector();
