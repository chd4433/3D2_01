...
void CGameFramework::BuildObjects()
{
	...
	wcscpy_s(pstrOutputText, 256, L"TIME");
...
void CGameFramework::ProcessInput()
{
	...
	if (!bProcessedByScene)
	{
		...
		if (pKeysBuffer['C'] & 0xF0 && m_pPlayer->GetPosition().y < MAX_HEGIHT) dwDirection |= DIR_UP;
		if (pKeysBuffer['V'] & 0xF0) dwDirection |= DIR_DOWN;
...
{    
	...
	{
		m_pUILayer->ObjPosition[i] = pp[i]->GetPosition();
	}
